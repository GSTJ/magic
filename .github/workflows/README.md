...
[`setup-ios-e2e`](../actions/setup-ios-e2e/action.yml),
[`build-ios-app`](../actions/build-ios-app/action.yml) and
[`run-maestro`](../actions/run-maestro/action.yml), are usable on their
...
`type` to `interface` direction is the dangerous one, see the Read-this note in
