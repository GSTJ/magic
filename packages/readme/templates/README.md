...
1. <First mechanism step.>
2. <Second mechanism step.>
3. <Third mechanism step.>

```ts
// <One code block where it helps. Delete otherwise.>
```
...
<Why it exists, configuration, gotchas. Keep hard-won knowledge under clear H2s.>
