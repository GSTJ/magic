/**
 * The magic bird, inline. Copied from `packages/video/public/magic-mark.svg`
 * so the mark travels with the export and needs no `basePath` prefixing.
 */
export const MagicMark = ({ size = 72 }: { size?: number }) => (
  <svg
    aria-label="The magic bird mark"
    fill="none"
    height={size}
    role="img"
    viewBox="0 0 48 48"
