<p align="center">
  <img alt="A tour of the repo: the magic mark, a file fixing its own lint, formatting and import order, the shared CI checks going green, and the theme palette washing through" src="https://assets.gabrieltaveira.dev/magic/magic-demo.gif" />
</p>
